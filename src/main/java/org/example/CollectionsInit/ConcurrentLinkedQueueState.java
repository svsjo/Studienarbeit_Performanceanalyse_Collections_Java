...
public class ConcurrentLinkedQueueState implements MinimumStateObject
{
    ...
    public ConcurrentLinkedQueue<Integer> collection;
    ...
    public ConcurrentLinkedQueue<Integer> GetRandomNumbers(int count)
    {
        ConcurrentLinkedQueue<Integer> collection = new ConcurrentLinkedQueue<Integer>();
