...
public class ConcurrentSkipListMapState implements MinimumStateObject
{
    ...
    public ConcurrentSkipListMap<Integer, Integer> collection;
    ...
    public ConcurrentSkipListMap<Integer, Integer> GetRandomNumbers(int count)
    {
        ConcurrentSkipListMap<Integer, Integer> collection = new ConcurrentSkipListMap<Integer, Integer>();
