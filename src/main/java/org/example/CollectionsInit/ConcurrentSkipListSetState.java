...
public class ConcurrentSkipListSetState implements MinimumStateObject
{
    ...
    public ConcurrentSkipListSet<Integer> collection;
    ...
    public ConcurrentSkipListSet<Integer> GetRandomNumbers(int count)
    {
        ConcurrentSkipListSet<Integer> collection = new ConcurrentSkipListSet<Integer>();
