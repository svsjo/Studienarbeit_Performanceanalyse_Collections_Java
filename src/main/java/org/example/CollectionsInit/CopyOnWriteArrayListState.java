...
public class CopyOnWriteArrayListState implements MinimumStateObject
{
    ...
    public CopyOnWriteArrayList<Integer> collection;
    ...
    public CopyOnWriteArrayList<Integer> GetRandomNumbers(int count)
    {
