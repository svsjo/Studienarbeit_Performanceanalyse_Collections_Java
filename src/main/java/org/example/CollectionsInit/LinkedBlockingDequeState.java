...
public class LinkedBlockingDequeState implements MinimumStateObject
{
    ...
    public LinkedBlockingDeque<Integer> collection;
    ...
    public LinkedBlockingDeque<Integer> GetRandomNumbers(int count)
    {
        LinkedBlockingDeque<Integer> collection = new LinkedBlockingDeque<Integer>();
