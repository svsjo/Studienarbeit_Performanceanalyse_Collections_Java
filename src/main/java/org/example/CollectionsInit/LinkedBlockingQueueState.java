...
public class LinkedBlockingQueueState implements MinimumStateObject
{
    ...
    public LinkedBlockingQueue<Integer> collection;
    ...
    public LinkedBlockingQueue<Integer> GetRandomNumbers(int count)
    {
        LinkedBlockingQueue<Integer> collection = new LinkedBlockingQueue<Integer>();
