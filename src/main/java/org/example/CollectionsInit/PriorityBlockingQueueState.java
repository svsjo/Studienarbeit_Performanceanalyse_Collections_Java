...
public class PriorityBlockingQueueState implements MinimumStateObject
{
    ...
    public PriorityBlockingQueue<Integer> collection;
    ...
    public PriorityBlockingQueue<Integer> GetRandomNumbers(int count)
    {
        PriorityBlockingQueue<Integer> collection = new PriorityBlockingQueue<Integer>();
