...
public class TreeMapState implements MinimumStateObject
{
    ...
    public TreeMap<Integer, Integer> collection;
    ...
    public TreeMap<Integer, Integer> GetRandomNumbers(int count)
    {
